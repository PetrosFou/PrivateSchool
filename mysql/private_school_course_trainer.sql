...
CREATE TABLE `course_trainer` (
  ...
  `trainer_is` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `course__course_id_idx` (`course_id`),
  KEY `course_trainer_id_idx` (`trainer_is`),
  CONSTRAINT `course__course_id` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`),
  CONSTRAINT `course_trainer_id` FOREIGN KEY (`trainer_is`) REFERENCES `trainer` (`id`)
...
-- Dump completed on 2021-02-04 12:38:56
