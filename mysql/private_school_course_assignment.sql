...
CREATE TABLE `course_assignment` (
  ...
  PRIMARY KEY (`id`),
  KEY `course_assignment_id_idx` (`assignement_id`),
  KEY `c_course_id_idx` (`course_id`),
  CONSTRAINT `c_course_id` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`),
  CONSTRAINT `course_assignment_id` FOREIGN KEY (`assignement_id`) REFERENCES `assignment` (`id`)
